...
{
  NONE, // No DRM or no errors
  DRM_NOT_SUPPORTED, // The stream use a not supported DRM
  DECRYPTER_ERROR, // DRM decrypter errors
};
...
struct DRMSession
{
  std::string id; // Custom engine session ID
  std::string drmId; // DRM session ID
