...
bool adaptive::CDashTree::ParseManifest(std::string& data)
{
  xml_document doc;
                                                 ...
                                                 bool& hasReprURN)
{
  ...
  if (nodeSegTpl)
  {
    ...
    if (segTemplate.GetStartNumber() > 0)
...
void adaptive::CDashTree::SetManifestUpdateParam(std::string& manifestUrl, std::string_view param)
{
